...
<body class="bg-surface-3 primary-3">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="card-product">
                                    <div class="card-product-wrapper asp-ratio-0">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="img-product lazyload" data-src="images/products/shree/p1.png"
                                                src="{{ asset('images/products/shree/p1.png') }}" alt="image-product">
                                            <img class="img-hover lazyload" data-src="images/products/shree/p2.png"
                                                src="{{ asset('images/products/shree/p2.png') }}" alt="image-product">
                                        </a>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="name-product link fw-medium text-md">Bird
                                            of
                                            Paradise</a>
                                        <p class="price-wrap fw-medium">
                                            <span class="price-new text-xl text-primary">₹130.00</span>
                                        ...
                                        <ul class="list-color-product style-2">
                                            ...
                                            <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                                ...
                                                <img class=" lazyload" data-src="images/products/shree/p2.png"
                                                    src="{{ asset('images/products/shree/p2.png') }}" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Black</span>
                                                <span class="swatch-value bg-dark"></span>
                                                <img class=" lazyload" data-src="{{ asset('images/products/shree/p3.png') }}"
                                                    src="{{ asset('images/products/shree/p3.png') }}" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product-wrapper asp-ratio-0">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="img-product lazyload" data-src="{{ asset('images/products/shree/p4.png') }}"
                                                src="{{ asset('images/products/shree/p4.png') }}" alt="image-product">
                                            <img class="img-hover lazyload" data-src="{{ asset('images/products/shree/p5.png') }}"
                                                src="{{ asset('images/products/shree/p5.png') }}" alt="image-product">
                                        </a>
                                        <ul class="list-product-btn">
                                            <li>
                                                <a href="#quickAdd" data-bs-toggle="modal"
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="name-product link fw-medium text-md">Ficus
                                            'Ruby'</a>
                                        <p class="price-wrap fw-medium">
                                            <span class="price-new text-xl text-primary">₹110.00</span>
                                        ...
                                        <ul class="list-color-product style-2">
                                            <li class="list-color-item hover-tooltip tooltip-bot color-swatch active">
                                                ...
                                                <img class=" lazyload" data-src="{{ asset('images/products/shree/p4.png') }}"
                                                    src="{{ asset('images/products/shree/p4.png') }}" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Black</span>
                                                <span class="swatch-value bg-dark"></span>
                                                <img class=" lazyload" data-src="{{ asset('images/products/shree/p5.png') }}"
                                                    src="{{ asset('images/products/shree/p5.png') }}" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Taupe Brown</span>
                                                <span class="swatch-value bg-taupe-brown"></span>
                                                <img class=" lazyload" data-src="{{ asset('images/products/shree/p6.png') }}"
                                                    src="{{ asset('images/products/shree/p6.png') }}" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product-wrapper asp-ratio-0">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="img-product lazyload" data-src="{{ asset('images/products/shree/p1.png') }}"
                                                src="{{ asset('images/products/shree/p1.png') }}" alt="image-product">
                                            <img class="img-hover lazyload" data-src="{{ asset('images/products/shree/p2.png') }}"
                                                src="{{ asset('images/products/shree/p2.png') }}" alt="image-product">
                                        </a>
                                        <ul class="list-product-btn">
                                            <li>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="name-product link fw-medium text-md">Olive
                                            Sipper</a>
                                        <p class="price-wrap fw-medium">
                                            <span class="price-new text-xl">₹150.00</span>
                                        </p>
                                        <ul class="list-color-product style-2">
                                            <li class="list-color-item hover-tooltip tooltip-bot color-swatch active">
                                                <span class="tooltip color-filter">Reddish Brown</span>
                                                <span class="swatch-value bg-reddish-brown"></span>
                                                <img class="lazyload" data-src="{{ asset('images/products/shree/p1.png') }}"
                                                    src="{{ asset('images/products/shree/p1.png') }}" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Blue</span>
                                                <span class="swatch-value bg-blue-2"></span>
                                                <img class="lazyload" data-src="{{ asset('images/products/shree/p2.png') }}"
                                                    src="{{ asset('images/products/shree/p2.png') }}" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Terra Cotta</span>
                                                <span class="swatch-value bg-terra-cotta"></span>
                                                <img class="lazyload" data-src="images/products/shree/p3.png"
                                                    src="{{ asset('images/products/shree/p3.png') }}" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="name-product link fw-medium text-md">ZZ
                                            Sipper</a>
                                        <p class="price-wrap fw-medium">
                                            <span class="price-new text-xl">₹145.00</span>
    ...
    <!-- search -->
    <div class="modal fade popup-search" id="search" data-bs-backdrop="false">
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="card-product">
                                                    ...
                                                    <ul class="list-product-btn">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0);"
                                                                class="btn-quickview hover-tooltip tooltip-left box-icon quickview">
                                                                <span class="icon icon-view"></span>
                                                                <span class="tooltip">Quick View</span>
                                                            </a>
                                                        </li>
                                                        <li class="compare">
                                                            <a href="javascript:void(0);"
                                                                class="btn-compare hover-tooltip tooltip-left box-icon">
                                                                <span class="icon icon-compare"></span>
                                                                <span class="tooltip">Add to Compare</span>
                                                            </a>
                                                        </li>
                                                ...
                                                <div class="card-product-info">
                                                    <a href="product-detail.html"
                                                        class="name-product link fw-medium text-md">Bird
                                                        of
                                                        Paradise</a>
                                                    <p class="price-wrap fw-medium">
                                                        <span class="price-new text-xl text-primary">₹130.00</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card-product">
                                                ...
                                                <div class="card-product-info">
                                                    <a href="product-detail.html"
                                                        class="name-product link fw-medium text-md">Ficus
                                                        'Ruby'</a>
                                                    <p class="price-wrap fw-medium">
                                                        <span class="price-new text-xl text-primary">₹110.00</span>
                                                        <span class="price-old">₹130.00</span>
                                                    ...
                                                    <ul class="list-color-product style-2">
                                                        <li
                                                            class="list-color-item hover-tooltip tooltip-bot color-swatch active">
                                                            <span class="tooltip color-filter">Beige</span>
                                                            <span class="swatch-value bg-light-beige-2"></span>
                                                            <img class=" lazyload"
                                                                data-src="images/products/shree/p4.png"
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card-product">
                                                ...
                                                <div class="card-product-info">
                                                    <a href="product-detail.html"
                                                        class="name-product link fw-medium text-md">Olive
                                                        Sipper</a>
                                                    <p class="price-wrap fw-medium">
                                                        <span class="price-new text-xl">₹150.00</span>
                                                    </p>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card-product">
                                                ...
                                                <div class="card-product-info">
                                                    <a href="product-detail.html"
                                                        class="name-product link fw-medium text-md">ZZ
                                                        Sipper</a>
                                                    <p class="price-wrap fw-medium">
                                                        <span class="price-new text-xl">₹145.00</span>
                                                        <span class="price-old">₹160.00</span>
                        ...
                        <div class="tf-mini-cart-sroll">
                            <div class="tf-mini-cart-items">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        <div class="d-flex justify-content-between">
                                            <a class="title link text-md fw-medium" href="product-detail.html">Ficus
                                                'Ruby'</a>
                                            <i class="icon icon-close remove fs-12"></i>
                                        </div>
                                        <p class="price-wrap text-sm fw-medium">
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="tf-mini-cart-item line radius-16">
                                                ...
                                                <div class="tf-mini-cart-info justify-content-center">
                                                    <a class="title link text-md fw-medium"
                                                        href="product-detail.html">Olive Sipper</a>
                                                    <p class="price-wrap text-sm fw-medium">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-mini-cart-item line radius-16">
                                                ...
                                                <div class="tf-mini-cart-info justify-content-center">
                                                    <a class="title link text-md fw-medium"
                                                        href="product-detail.html">ZZ Sipper</a>
                                                    <p class="price-wrap text-sm fw-medium">
                                                        <span class="new-price text-primary">₹145.00</span>
                                                        <span
                                                            class="old-price text-decoration-line-through text-dark-1">₹160.00</span>
                                                    </p>
                                                    <a href="#"
                                                        class="tf-btn animate-btn d-inline-flex bg-dark-2 w-max-content">Add
                                                        to cart</a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-mini-cart-item line radius-16">
                                                ...
                                                <div class="tf-mini-cart-info justify-content-center">
                                                    <a class="title link text-md fw-medium"
                                                        href="product-detail.html">Ficus 'Ruby'</a>
                                                    <p class="price-wrap text-sm fw-medium">
                    ...
                    <div class="tf-mini-cart-bottom">
                        ...
                        <div class="tf-mini-cart-bottom-wrap">
                            <div class="tf-cart-totals-discounts">
                                ...
                                <div class="tf-totals-total-value text-xl fw-medium">₹130.00 </div>
                            </div>
                            ...
                            <div class="tf-cart-checkbox">
                                ...
                                <label for="CartDrawer-Form_agree" class="text-sm">
                                    I agree with the
                                    <a href="#" title="Terms of Service" class="fw-medium">terms
                                        and conditions</a>
                                </label>
                            </div>
                    ...
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" data-color="white">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/shree/p1.png"
                                        src="images/products/shree/p1.png" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide" data-color="brown" data-size="medium">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/shree/p2.png"
                                        src="images/products/shree/p2.png" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide" data-color="black">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/shree/p3.png"
                                        src="images/products/shree/p3.png" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tf-product-info-wrap">
                    <div class="tf-product-info-inner">
                        <div class="tf-product-heading">
                            <h6 class="product-name"><a href="product-detail.html" class="link">Bird of
                                    Paradise</a></h6>
                        ...
                        <div class="tf-product-variant">
                            <div class="variant-picker-item variant-color">
                                <div class="variant-picker-label">
                                    Color:<span class="variant-picker-label-value value-currentColor">White</span>
                                </div>
                                <div class="variant-picker-values">
                                    <div class="hover-tooltip color-btn active" data-color="white">
                                        <span class="check-color bg-white"></span>
                                        <span class="tooltip">White</span>
                                    </div>
                                    <div class="hover-tooltip color-btn" data-color="brown">
                                        <span class="check-color bg-brown-9"></span>
                                        <span class="tooltip">Brown</span>
                                    </div>
                                    <div class="hover-tooltip color-btn" data-color="black">
                ...
                <div class="main-product-quickadd card-product">
                    <div class="item-product-info">
                        ...
                        <div class="content-box">
                            <a href="product-detail.html" class="name-product link text-lg">Bird of Paradise</a>
                    ...
                    <div class="item-product-variant">
                        <div class="quickadd-variant-color">
                            <div class="variant-label text-md">Color: <span class="variant-value">White</span></div>
                            <ul class="list-color-product">
                                ...
                                <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                    <span class="tooltip color-label">Brown</span>
                                    <span class="swatch-value bg-brown-9"></span>
                                    <img class="lazyload" data-src="images/products/shree/p2.png"
                                        src="images/products/shree/p2.png" alt="image-product">
                                </li>
                    ...
                    <div class="tf-compare-inner">
                        <div class="tf-compare-list">
                            <div class="tf-compare-item file-delete">
                                ...
                                <div class="content">
                                    <div class="text-title">
                                        <a class="link text-line-clamp-2" href="product-detail.html">Bird of
                                            Paradise</a>
                                    </div>
                                    <p class="price-wrap">
                                        <span class="new-price text-primary">₹130.00</span>
                            ...
                            <div class="tf-compare-item file-delete">
                                ...
                                <a href="product-detail.html" class="image">
                                    <img class="lazyload" data-src="images/products/shree/p4.png"
                                        src="images/products/shree/p4.png" alt="">
                                </a>
                                <div class="content">
                                    <div class="text-title">
