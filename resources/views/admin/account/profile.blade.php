    ...
    <div class="container-fluid">
        ...
        <div class="profile-foreground position-relative mx-n4 mt-n4">
            <div class="profile-wid-bg custom-blur">
                <img src="{{ asset('msg/default-profile-bg.png')  }}" alt="" class="profile-wid-img" />
            </div>
        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="acitivity-timeline">
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="mb-1">Nancy Martino <span class="badge bg-secondary-subtle text-white align-middle">In
                                                        Progress</span></h6>
                                        ...
                                        <div class="acitivity-item d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted mb-2">User <span class="text-white">Erica245</span> submitted a
                                                    ticket.</p>
